...
//	}
	...
	private ResponseEntity updateVoucherStatus(@RequestParam int voucherID) throws CrudException {
	 ...
	 @DeleteMapping()
	  private ResponseEntity deleteVoucher(@RequestParam int voucherID) throws CrudException {
			return ResponseEntity.ok().body(voucherService.deleteVoucherByID(voucherID));
		}
}
